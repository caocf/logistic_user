...
public class SlideBottomPanel extends FrameLayout {
	...
	public boolean isPanelOnTouch = false;
	...
	public SlideBottomPanel(Context context, AttributeSet attrs,
		...
		// mBackgroundId =
		// a.getResourceId(R.styleable.SlideBottomPanel_sbp_background_layout,
		...
		// mHidePanelTitle =
		// a.getBoolean(R.styleable.SlideBottomPanel_sbp_hide_panel_title,
	...
	// mDarkFrameLayout.addView(LayoutInflater.from(mContext).inflate(mBackgroundId,
	// null));
	...
	private void handleActionMove(MotionEvent event) {
		...
		if (isDragging) {
			...
			// (int)((1 - currentY / (mMeasureHeight - mTitleHeightNoDisplay)) *
			// DarkFrameLayout.MAX_ALPHA));
			// }
			// }
			if (!mBoundary) {
	...
	private void hidePanel() {
		...
		animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator animation) {
				...
				// mDarkFrameLayout.fade((int) ((1 - value / t) *
				// DarkFrameLayout.MAX_ALPHA));
				// }
			}
		});
	...
	public void displayPanel() {
		...
		animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator animation) {
				...
				ViewHelper.setY(mPanel, value);
				// if (mDarkFrameLayout != null && mIsFade
				// && mDarkFrameLayout.getCurrentAlpha() !=
				// DarkFrameLayout.MAX_ALPHA) {
				// mDarkFrameLayout.fade(
				// (int) ((1 - value / (mMeasureHeight - mTitleHeightNoDisplay))
				// * DarkFrameLayout.MAX_ALPHA));
				// }
			}
		});
		...
		if (panel instanceof FrameLayout) {
			try {
				if (((FrameLayout) panel).getChildAt(1).getVisibility() != View.VISIBLE) {
					((FrameLayout) panel).getChildAt(1).setVisibility(
							View.VISIBLE);
				}
